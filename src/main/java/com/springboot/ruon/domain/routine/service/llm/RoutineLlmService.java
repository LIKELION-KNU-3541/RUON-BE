...
public class RoutineLlmService {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            - 같은 시간대(timeOfDay) 안에서 동일한 productId와 action 조합을 두 번 이상 넣지 마세요.
              (예: 저녁 루틴에 같은 제품으로 CLEANSE 스텝을 두 번 만들면 안 됩니다.) 제품이 부족해서 같은 제품을 여러 스텝에 쓰더라도, 각 스텝은 서로 다른 action이어야 합니다.
